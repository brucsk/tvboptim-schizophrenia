...
data_dir = r"D:\Cogmaster\M2\stage\data\processed_AAL90"
cond0_filename = "TS_Control.npy"
cond1_filename = "TS_Schizo.npy"
result_dir = "D:/Cogmaster/M2/stage/results/TVBOptim_RWW/AAL90_test"
os.makedirs(result_dir, exist_ok=True)

# Set dataset parameters
n_sub = 48
n_nodes = 90 # size of network for AAL90
conds = ['CTR', 'SCZ']
...
sc_files_path = 'D:\\Cogmaster\\M2\\stage\\data\\connectivity_AAL90'
weights, delays, labels = load_structural_connectivity_AAL90(sc_files_path=sc_files_path)
